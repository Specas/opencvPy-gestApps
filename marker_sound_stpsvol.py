...
pygame.init()
# load the music
pygame.mixer.music.load('The bitter truth.mp3')
...
while 1:
	...
	if cent_yellowx!=-1 and cent_yellowy!=-1 and cent_bluex!=-1 and cent_bluey!=-1:
		...
		vol_gain = cent_yellowy - cent_bluey
		# print vol_gain
		if vol_gain<0:
			# set volume to zero
			...
			pygame.mixer.music.set_volume(1.0*(vol_gain/90.0))

		# volume control
		pass


	elif cent_yellowx!=-1 and cent_yellowy!=-1 and cent_bluex==-1 and cent_bluey==-1:
		# pause
